<?php
	...
	echo "Time is ".date("h:i:sa")."<br>"; //a is am or pm
	date_default_timezone_set("Asia/Rangoon");
	echo "Rangoon Time is ".date("h:i:sa")."<br>";
	...
	echo $nexttwoWeek."<br>";
	echo "Coming Sunday is : ".date('d M,Y',$nexttwoWeek)."<br>";
	echo "<hr>";

	$after3Months = strtotime("+3 months");
	echo $after3Months."<br>";
	echo "Coming Sunday is : ".date('d M,Y',$after3Months)."<br>";
	echo "<hr>";
