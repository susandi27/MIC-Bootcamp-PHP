                            ...
                            <table class="table table-hover table-bordered display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?= $pending_total; ?> </td>
                                        <td>
                                            <a href="invoice.php?id=<?= $pending_id ?>" class="btn btn-outline-info"> 
                            ...
                            <table class="table table-hover table-bordered display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?= $confirm_total; ?> </td>
                                        <td>
                                            <a href="invoice.php?id=<? $confirm_id ?>" class="btn btn-outline-info"> 
                                                <i class="icofont-info"></i>
                                            </a>
                                        </td>
                                    </tr>
                            ...
                            <table class="table table-hover table-bordered display">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <?= $cancel_total; ?> </td>
                                        <td>
                                            <a href="invoice.php?<?php $cancel_id ?>" class="btn btn-outline-info"> 
                                                <i class="icofont-info"></i>
                                            </a>
                                        </td>
                                    </tr>
